...
fn fuzz_regression_8() {
    ...
    let actions: Vec<Action> = serde_json::from_str(
        r#"
            [
                {"RegisterUser":{"username":"badger","email":"ktqpc@r.edu","password":"u@p.edu"}},
                {"CreateTournament":{"name":"otter","abbrv":"otter","slug":"9"}},
                {"CreateRound":{"tournament_idx":17450235815526992768,"name":"geckolynx","category_idx":null,"seq":3704891009}},
                {"SetDrawPublished":{"tournament_idx":15560977863625712406,"round_idx":5539140434584956940,"status":"geckoK","published":false}}
            ]
        "#,
    )
    .unwrap();
...
fn fuzz_regression_9() {
    ...
    let actions: Vec<Action> = serde_json::from_str(
        r##"
            [
                {"RegisterUser":{"username":"lynx","email":"n@t.net","password":"otterm"}},
                {"CreateTournament":{"name":"lynx","abbrv":"#'","slug":"5"}},
                {"CreateRound":{"tournament_idx":17450235815526992768,"name":"ibex","category_idx":null,"seq":3704891009}},
                {"CreateTeam":{"tournament_idx":12859288371916044276,"name":"m@zxa.edu","institution_idx":6096518413307153036}},
                {"UpdateTeamEligibility":{"tournament_idx":5276348018414723978,"round_idx":1789480561640248358,"team_idx":2272482804264980819,"eligible":true}}
            ]
        "##,
    )
    .unwrap();
...
fn fuzz_regression_10() {
    ...
    let actions: Vec<Action> = serde_json::from_str(
        r##"
            [
                {"RegisterUser":{"username":"lynx","email":"j@u.com","password":"badger"}},
                {"CreateTournament":{"name":"lynx","abbrv":"#'","slug":""}},
                {"CreateTeam":{"tournament_idx":3722362722439516023,"name":"ibex","institution_idx":null}},
                {"CreateSpeaker":{"tournament_idx":5423000715285638366,"team_idx":12554803734179507107,"name":"","email":"s@d.edu"}},
                {"CreateSpeaker":{"tournament_idx":5423000715285638366,"team_idx":12554803734179507107,"name":"","email":"s@d.edu"}}
            ]
        "##,
    )
    ...
    let actions: Vec<Action> = serde_json::from_str(
        r##"
            [
                ...
                {"CreateTournament":{"name":"lynx","abbrv":"#'","slug":"5"}},
                {"CreateRound":{"tournament_idx":17450235815526992768,"name":"otter","category_idx":null,"seq":3704891009}},
                {"CreateJudge":{"tournament_idx":8499350102782993214,"name":"O","email":"t@kfxgl.org","institution_idx":null}},
                {"UpdateJudgeAvailability":{"tournament_idx":11899860224442337296,"round_idx":10874088187031351535,"judge_idx":16169535860131660169,"available":false}}
            ]
        "##,
    )
    .unwrap();
    ...
    let actions: Vec<Action> = serde_json::from_str(
        r##"
            [
                {"RegisterUser":{"username":"ibex","email":"j@u.com","password":"badger"}},
                {"CreateTournament":{"name":"lynx","abbrv":"#'","slug":""}},
                {"CreateTeam":{"tournament_idx":3722362722439516023,"name":"otter","institution_idx":null}},
                {"CreateRound":{"tournament_idx":17450235815526992768,"name":"otter","category_idx":null,"seq":3704891009}},
                {"CreateTeam":{"tournament_idx":242422903909379060,"name":"gecko","institution_idx":13234450210839701354}},
                {"CreateTeam":{"tournament_idx":242422903909379060,"name":"otterI","institution_idx":13234450210839701354}},
                {"CreateTeam":{"tournament_idx":3722362722439516023,"name":"otter","institution_idx":null}},
                {"UpdateAllTeamEligibility":{"tournament_idx":7396986980960405109,"round_idx":8133550729161990292,"eligible":true}},
                {"GenerateDraw":{"tournament_idx":13551309544817346702,"round_idx":5011526869859920553}},
                {"GenerateDraw":{"tournament_idx":13551309544817346702,"round_idx":5011526869859920553}}
            ]
        "##,
    )
